    ...
    <div class="navbar navbar-expand-lg landing-navbar px-3 px-md-8">
      ...
      <div class="navbar-collapse landing-nav-menu" id="navbarSupportedContent">
        ...
        <ul class="navbar-nav mx-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="/#top">{{ __('') }}</a>
          </li>
          <li class="nav-item">
      ...
      <ul class="navbar-nav flex-row align-items-center ms-auto">
        ...
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu dropdown-menu-end p-3" aria-labelledby="langDropdown"
            style="min-width:auto;width:auto;">
            <li class="m-0"><a class="dropdown-item py-2 px-3" href="/lang/en" style="margin-bottom:10;">English</a>
            </li>

            <li class="m-0"><a class="dropdown-item py-2 px-3" href="/lang/ar" style="margin-bottom:10;">العربية</a>
            </li>
          </ul>
        </li>
